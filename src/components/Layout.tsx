...
import { LayoutDashboard, Users, FolderKanban, LogOut, Upload, ClipboardList, Sun, Moon, ChevronDown, GraduationCap, CalendarRange, BookmarkPlus } from 'lucide-react';
...
const Layout = () => {
  ...
  const navItems = [
    ...
    { path: '/admin/holiday-templates', label: 'Kho ngày lễ', icon: <BookmarkPlus size={20} />, roles: ['Admin'] },
